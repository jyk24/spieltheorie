...
RAETSEL_META = [
    ...
    # ── Mathematik & Philosophie (neu) ─────────────────────────────────────────
    {"id":"cantor-diagonale","name":"Cantors Diagonalargument","icon":"♾️","beschreibung":"Die Menge der natürlichen Zahlen ist unendlich. Die der reellen Zahlen auch. Cantor (1891) bewies: Eine ist größer als die andere. Es gibt verschiedene Stufen der Unendlichkeit – und das veränderte die Mathematik.","typ":"Mathematik-Paradox","schwierigkeit":"Fortgeschritten","dauer":"5 min","kategorie":"Mathematik"},
    {"id":"banach-tarski","name":"Das Banach-Tarski-Paradoxon","icon":"🔮","beschreibung":"Eine Kugel lässt sich in endlich viele Stücke zerlegen und – nur durch Drehen und Verschieben – zu zwei identischen Kugeln zusammensetzen. Was klingt wie Magie, ist beweisbares Theorem.","typ":"Mathematik-Paradox","schwierigkeit":"Fortgeschritten","dauer":"5 min","kategorie":"Mathematik"},
    {"id":"muenchhausen-trilemma","name":"Das Münchhausen-Trilemma","icon":"🪜","beschreibung":"Jede Behauptung verlangt eine Begründung. Aber wo endet die Begründungskette? Hans Albert (1968) zeigte: Drei Ausgänge sind möglich – und alle drei sind unbefriedigend.","typ":"Erkenntnistheorie","schwierigkeit":"Mittel","dauer":"4 min","kategorie":"Logik"},
    {"id":"sorites","name":"Das Sorites-Paradoxon (Haufen)","icon":"🪨","beschreibung":"Ein Haufen Sand bleibt ein Haufen, wenn man ein Korn entfernt. Doch nach genug Wiederholungen bleibt nur ein Korn – und das ist kein Haufen mehr. Wo liegt die Grenze?","typ":"Logik-Paradox","schwierigkeit":"Mittel","dauer":"3 min","kategorie":"Logik"},
    {"id":"olbers","name":"Olbers' Paradoxon","icon":"🌌","beschreibung":"Ist das Universum unendlich groß und überall mit Sternen erfüllt, müsste der Nachthimmel hell wie die Sonne sein. Er ist es nicht. Warum? Die Antwort verbindet Astronomie mit dem Alter des Kosmos.","typ":"Physik-Paradox","schwierigkeit":"Mittel","dauer":"4 min","kategorie":"Physik"},
]
...
GENERIC_PUZZLES: dict = {
    ...
    # ── Mathematik & Philosophie (neu) ─────────────────────────────────────────
    "cantor-diagonale": {
        "id": "cantor-diagonale", "name": "Cantors Diagonalargument", "icon": "♾️",
        "farbe": "indigo", "kategorie": "Mathematik",
        "schwierigkeit": "Fortgeschritten", "dauer": "5 min",
        "setup": "Stell dir vor, jemand behauptet: \"Ich kann jede reelle Zahl zwischen 0 und 1 in einer Liste durchnummerieren – die erste, zweite, dritte usw.\" Cantor stellt die Frage: Stimmt das? Lassen sich die reellen Zahlen mit den natürlichen Zahlen 1, 2, 3, … paaren?",
        "frage": "Wie zeigt Cantor, dass keine solche Auflistung möglich ist?",
        "optionen": [
            {"text": "Er zeigt, dass jede Liste unendlich lang werden müsste", "hinweis": "Das stört nicht – ℕ ist auch unendlich"},
            {"text": "Er konstruiert aus jeder Liste eine reelle Zahl, die nicht in ihr vorkommt", "hinweis": "Diagonale Konstruktion"},
            {"text": "Er beweist, dass π und e nicht gelistet werden können", "hinweis": "Das ist nicht das Argument"},
            {"text": "Er zeigt, dass die Liste niemals endet", "hinweis": "Endlichkeit ist nicht das Problem"},
        ],
        "loesung_text": "Er konstruiert eine reelle Zahl, die sich von der n-ten Zahl an der n-ten Nachkommastelle unterscheidet",
        "erklaerung": "<p>Annahme: Es gäbe eine vollständige Liste aller reellen Zahlen in [0,1]. Cantor baut nun eine neue Zahl x: ihre n-te Nachkommastelle wählt er so, dass sie sich von der n-ten Stelle der n-ten Listenzahl unterscheidet (z. B. immer +1 mod 10). Diese Zahl x kann nirgends in der Liste stehen — denn an Position n unterscheidet sie sich von der n-ten Listenzahl. Widerspruch. Die reellen Zahlen sind <em>überabzählbar</em>: |ℝ| > |ℕ|.</p>",
        "kontext": "<p>Cantor (1891) führte verschiedene Stufen der Unendlichkeit ein: ℵ₀ (abzählbar) und 2^ℵ₀ (Kontinuum). Die Frage, ob es etwas dazwischen gibt (Kontinuumshypothese), wurde 1963 von Cohen als formal unentscheidbar bewiesen. Cantors Ideen wurden zu seiner Zeit als blasphemisch und 'mathematische Krankheit' bezeichnet — heute sind sie Fundament der Mathematik.</p>",
        "erkenntnis": "Unendlichkeit ist nicht ein einzelner Begriff, sondern eine Hierarchie. Was 'gleich groß' bedeutet, muss präzise definiert werden – sonst irrt selbst die Intuition über das Selbstverständlichste.",
    },
    "banach-tarski": {
        "id": "banach-tarski", "name": "Das Banach-Tarski-Paradoxon", "icon": "🔮",
        "farbe": "violet", "kategorie": "Mathematik",
        "schwierigkeit": "Fortgeschritten", "dauer": "5 min",
        "setup": "Banach und Tarski (1924) bewiesen: Eine massive Kugel im ℝ³ lässt sich in endlich viele Teilmengen zerlegen, die – nur durch Drehung und Verschiebung – zu zwei massiven Kugeln zusammengesetzt werden können, jede so groß wie das Original.",
        "frage": "Wie ist das mit dem Volumen-Erhaltungssatz vereinbar?",
        "optionen": [
            {"text": "Es ist ein praktischer Trick mit Fraktalen", "hinweis": "Die Stücke sind viel seltsamer"},
            {"text": "Die Stücke sind nicht messbar – sie haben kein wohldefiniertes Volumen", "hinweis": "Maßtheorie schlägt zurück"},
            {"text": "Das Theorem ist bei genauerem Hinsehen falsch", "hinweis": "Es ist beweisbar wahr"},
            {"text": "Das funktioniert nur in höheren Dimensionen, nicht in ℝ³", "hinweis": "Es geht ausgerechnet in ℝ³"},
        ],
        "loesung_text": "Die Zerlegungsstücke sind nicht Lebesgue-messbar",
        "erklaerung": "<p>Volumen-Erhaltung gilt nur für <em>messbare</em> Mengen. Banach-Tarski-Stücke sind <em>nicht messbar</em>: sie haben keine wohldefinierte Größe. Der Beweis nutzt das Auswahlaxiom (Axiom of Choice), um pathologische Mengen zu konstruieren, die die freie nicht-abelsche Gruppe der Drehungen ausnutzen. In ℝ und ℝ² gibt es keinen analogen Effekt – nur ab Dimension 3 wird die Drehgruppe reichhaltig genug.</p>",
        "kontext": "<p>Das Resultat hat keine physische Konsequenz: Atome sind diskret, das Auswahlaxiom braucht Stetigkeit ohne Konstruktionsvorschrift. Doch es zeigt, wie tief Auswahlaxiom und Maßtheorie unsere Vorstellung von 'Volumen' formen. Manche Mathematiker lehnen das Auswahlaxiom deshalb ab – andere akzeptieren das Paradoxon als Preis für seine Eleganz.</p>",
        "erkenntnis": "Was unmöglich aussieht, kann in einem Axiomensystem trotzdem beweisbar sein. Die Mathematik ist nicht das Universum – sie ist eine Familie konsistenter Spielregeln, deren Folgen wir akzeptieren oder ablehnen.",
    },
    "muenchhausen-trilemma": {
        "id": "muenchhausen-trilemma", "name": "Das Münchhausen-Trilemma", "icon": "🪜",
        "farbe": "amber", "kategorie": "Logik",
        "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Du behauptest: \"X ist wahr.\" Jemand fragt: \"Warum?\" Du nennst Grund Y. \"Und warum Y?\" – Grund Z. Und so weiter. Hans Albert (1968) zeigt: Diese Begründungskette muss irgendwann enden – aber wie?",
        "frage": "Welche drei Möglichkeiten zur Beendigung der Begründungskette gibt es – und warum sind alle problematisch?",
        "optionen": [
            {"text": "Unendlicher Regress, Zirkelschluss oder dogmatischer Abbruch", "hinweis": "Das klassische Trilemma"},
            {"text": "Beweis, Erfahrung oder Autorität", "hinweis": "Das sind Begründungstypen, kein Trilemma"},
            {"text": "Induktion, Deduktion oder Abduktion", "hinweis": "Das sind Schlussformen"},
            {"text": "Mathematik, Logik oder Empirie", "hinweis": "Disziplinen, kein Trilemma"},
        ],
        "loesung_text": "Unendlicher Regress, logischer Zirkelschluss oder dogmatischer Abbruch",
        "erklaerung": "<p><strong>1. Unendlicher Regress:</strong> Jeder Grund braucht selbst einen Grund – nie endend. Praktisch nutzlos. <strong>2. Zirkelschluss:</strong> A wird durch B begründet, B durch A. Logisch wertlos. <strong>3. Dogmatischer Abbruch:</strong> Irgendwann sagt man 'das ist eben so' – willkürlich gegenüber Einwänden. Hans Albert (Traktat über kritische Vernunft) folgert: <em>absolute</em> Begründungen sind unmöglich. Erkenntnis ist immer fallibel.</p>",
        "kontext": "<p>Der Name geht auf Baron Münchhausen zurück, der sich angeblich am eigenen Schopf aus dem Sumpf zog. Das Trilemma ist Kernargument des kritischen Rationalismus (Popper, Albert): Wir können Hypothesen nie endgültig beweisen – nur kritisch prüfen und verwerfen. Wissenschaft ist deshalb keine Sammlung sicherer Wahrheiten, sondern ein offener Prozess der Falsifikation.</p>",
        "erkenntnis": "Wer absolute Gewissheit verlangt, landet in einem der drei Sümpfe. Reife Erkenntnis akzeptiert Vorläufigkeit – und tauscht Sicherheit gegen Korrigierbarkeit.",
    },
    "sorites": {
        "id": "sorites", "name": "Das Sorites-Paradoxon (Haufen)", "icon": "🪨",
        "farbe": "teal", "kategorie": "Logik",
        "schwierigkeit": "Mittel", "dauer": "3 min",
        "setup": "Prämisse 1: 1 Million Sandkörner bilden einen Haufen. Prämisse 2: Wenn n Körner ein Haufen sind, dann sind auch n−1 Körner ein Haufen (ein einzelnes Korn macht keinen Unterschied). Schlussfolgerung durch wiederholtes Anwenden: Auch 1 Korn ist ein Haufen. Aber das stimmt offensichtlich nicht.",
        "frage": "Wo bricht das Argument zusammen?",
        "optionen": [
            {"text": "Prämisse 1 ist falsch – 1 Million Körner sind kein Haufen", "hinweis": "Doch, ist es"},
            {"text": "Die Logik ist defekt – Modus Ponens gilt nicht", "hinweis": "Modus Ponens ist gültig"},
            {"text": "Das Prädikat 'Haufen' ist vage – es hat keine scharfe Grenze", "hinweis": "Vagheitstheorie"},
            {"text": "Sand verhält sich anders als Logik vorschreibt", "hinweis": "Es geht um Begriffe, nicht Sand"},
        ],
        "loesung_text": "Das Prädikat 'Haufen' ist semantisch vage – es hat keinen scharfen Schwellenwert",
        "erklaerung": "<p>Vage Prädikate (\"Haufen\", \"groß\", \"reich\") haben Grenzfälle, in denen weder klares Ja noch klares Nein gilt. Die zweite Prämisse ist <em>fast</em> immer wahr, aber irgendwo muss sie versagen. Drei Lösungsstrategien: <strong>1. Epistemizismus</strong> (Williamson): Es gibt eine scharfe Grenze – wir kennen sie nur nicht. <strong>2. Supervaluation</strong>: Aussagen sind nur dann wahr, wenn sie auf <em>jeder</em> präzisen Schärfung wahr sind. <strong>3. Fuzzy-Logik</strong>: Wahrheitswerte zwischen 0 und 1.</p>",
        "kontext": "<p>Das Paradoxon stammt aus der Antike (Eubulides, ~4. Jh. v. Chr.) und ist heute zentral in Sprachphilosophie und KI: Wann ist ein selbstfahrendes Auto 'sicher genug'? Wann ist eine medizinische Diagnose 'eindeutig'? Vagheit ist nicht heilbar – nur kontrollierbar.</p>",
        "erkenntnis": "Viele Begriffe, die im Alltag funktionieren, sind logisch unsauber. Die Welt zwingt uns Schwellen auf, die die Sprache nicht kennt – jede Schwelle ist eine Konvention, keine Entdeckung.",
    },
    "olbers": {
        "id": "olbers", "name": "Olbers' Paradoxon", "icon": "🌌",
        "farbe": "indigo", "kategorie": "Physik",
        "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Annahme (klassisch): Das Universum ist räumlich unendlich, statisch und gleichförmig mit Sternen besetzt. Heinrich Olbers (1823) zeigte: Dann müsste in jeder Sichtlinie irgendwann ein Stern liegen — der gesamte Nachthimmel müsste so hell wie die Sonnenoberfläche leuchten. Tut er aber nicht.",
        "frage": "Was löst das Paradoxon auf?",
        "optionen": [
            {"text": "Interstellarer Staub absorbiert das Licht", "hinweis": "Erwärmt sich – würde am Ende selbst leuchten"},
            {"text": "Das Universum ist endlich alt – Licht ferner Sterne hat uns nie erreicht", "hinweis": "Endliche Lichtgeschwindigkeit + endliches Alter"},
            {"text": "Sterne sind nicht gleichmäßig verteilt", "hinweis": "Hilft asymptotisch nicht"},
            {"text": "Die Schwerkraft krümmt das Licht weg", "hinweis": "Marginal, kein dominanter Effekt"},
        ],
        "loesung_text": "Das Universum hat ein endliches Alter (≈ 13,8 Mrd. Jahre) – das Licht weit entfernter Sterne ist noch nicht angekommen. Zusätzlich rotverschiebt die Expansion das verbleibende Licht ins Unsichtbare.",
        "erklaerung": "<p>Bei einem endlichen Alter t hat uns nur Licht aus einer Kugel mit Radius c·t erreicht — die Sterndichte in dieser Kugel reicht nicht für einen hellen Himmel. Hinzu kommt: Das Universum dehnt sich aus, das Licht weit entfernter Galaxien wird ins Infrarot und darüber hinaus rotverschoben (Mikrowellenhintergrund: ~2,7 K). Auch interstellarer Staub erklärt nichts — er erhitzt sich im Strahlungsgleichgewicht und würde selbst leuchten.</p>",
        "kontext": "<p>Olbers' Paradoxon ist eines der wenigen kosmologischen Argumente, das jeder bei Nacht selbst beobachten kann. Edgar Allan Poe (1848, 'Eureka') vermutete bereits eine Lösung über das endliche Alter. Heute stützt es zusammen mit Hubble-Expansion und Mikrowellenhintergrund das Urknall-Modell.</p>",
        "erkenntnis": "Manchmal ist das Auffälligste nicht das, was am Himmel steht — sondern das, was fehlt. Ein dunkler Nachthimmel ist Beweis dafür, dass das Universum eine Geschichte hat.",
    },
}
