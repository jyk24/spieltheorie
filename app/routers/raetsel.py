...
RAETSEL_META = [
    ...
    {"id":"parrondo","name":"Parrondos Paradoxon","icon":"🎲","beschreibung":"Zwei Glücksspiele, beide auf lange Sicht verlustbringend. Wechselst du zufällig zwischen ihnen, wird die Kombination plötzlich profitabel. Wie können zwei Verlierer zusammen gewinnen? Parrondo (1996) bewies: ja, das geht – mit weitreichenden Folgen für Biologie und Finanzen.","typ":"Wahrscheinlichkeits-Paradox","schwierigkeit":"Fortgeschritten","dauer":"5 min","kategorie":"Wahrscheinlichkeit"},
    {"id":"drei-gefangene","name":"Das Drei-Gefangenen-Problem","icon":"⛓️","beschreibung":"Drei Gefangene, einer wird zufällig begnadigt. Gefangener A fragt den Wärter: „Nenne mir einen der anderen beiden, der hingerichtet wird.\" Der Wärter sagt: „B wird hingerichtet.\" Ist As Überlebenschance jetzt 1/2 – oder immer noch 1/3? Die Antwort spaltet selbst Mathematiker.","typ":"Wahrscheinlichkeits-Paradox","schwierigkeit":"Mittel","dauer":"4 min","kategorie":"Wahrscheinlichkeit"},
]
...
GENERIC_PUZZLES: dict = {
    ...
    "parrondo": {
        "id": "parrondo", "name": "Parrondos Paradoxon", "icon": "🎲",
        "farbe": "violet", "kategorie": "Wahrscheinlichkeit",
        "schwierigkeit": "Fortgeschritten", "dauer": "5 min",
        "setup": "Du hast 100 € Startkapital und kannst zwischen zwei Glücksspielen wählen.<br><br><strong>Spiel A:</strong> Wirf eine leicht unfaire Münze. Gewinn 1 €, Verlust 1 €. Gewinnchance: 49,5 %. <em>Erwarteter Verlust: 1 % pro Runde.</em><br><br><strong>Spiel B:</strong> Zwei Münzen, abhängig von deinem Kontostand. Ist dein Kapital durch 3 teilbar, wirfst du eine sehr schlechte Münze (Gewinnchance 9,5 %). Sonst eine bessere (Gewinnchance 74,5 %). <em>Erwarteter Verlust: ~1 % pro Runde.</em><br><br>Beide Spiele verlieren auf lange Sicht – das hat Parrondo (1996) sauber bewiesen.",
        "frage": "Was passiert, wenn du <strong>zufällig zwischen A und B wechselst</strong> (z. B. bei jeder Runde eine faire Münze: Kopf = A, Zahl = B)?",
        "optionen": [
            {"text": "Du verlierst weiter – ein Mittelwert zweier Verluste ist immer Verlust.", "hinweis": "Das wäre die intuitive Antwort"},
            {"text": "Du gewinnst – die Kombination ist plötzlich profitabel.", "hinweis": "Parrondos Paradoxon"},
            {"text": "Du landest bei null – Gewinne und Verluste heben sich exakt auf.", "hinweis": "Wäre das der einzige Möglichkeitsraum?"},
            {"text": "Das Ergebnis hängt vom Startkapital ab.", "hinweis": "Spiel B reagiert auf den Kontostand – aber gilt das langfristig?"},
        ],
        "loesung_text": "Du gewinnst – obwohl beide Einzelspiele Verlierer sind.",
        "erklaerung": "<p>Das ist <strong>Parrondos Paradoxon</strong>, 1996 von dem spanischen Physiker Juan Parrondo entdeckt. Numerische Simulationen zeigen: Wechselt man zufällig (oder periodisch z. B. AABB AABB) zwischen Spiel A und B, wächst das Kapital im Erwartungswert um ca. <strong>+0,5 % pro Runde</strong> – aus zwei Verlierern wird ein Gewinner.</p><p>Der Trick liegt im <em>Zustand</em>: Spiel B verliert nur dann stark, wenn der Kontostand ein Vielfaches von 3 ist. Spiel A „verrückt\" zufällig den Kontostand und reduziert so die Häufigkeit dieser ungünstigen Zustände. Die Verteilung der Kontostände modulo 3 verschiebt sich – und plötzlich überwiegt die gute Münze in Spiel B.</p><p>Mathematisch beschreibt das eine <strong>Markow-Kette</strong>, deren stationäre Verteilung sich durch das Mischen verändert. Die Verluste der Einzelspiele sind nicht <em>linear</em> kombinierbar.</p>",
        "kontext": "<p><strong>Wo es vorkommt:</strong></p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><em>Biologie:</em> „Flashing-Ratchet\"-Modelle erklären, wie molekulare Motoren (Kinesin) gerichtete Bewegung aus rein zufälligen thermischen Fluktuationen erzeugen.</li><li><em>Evolution:</em> Zwei einzeln nachteilige Mutationen können in Kombination einen Fitness-Vorteil erzeugen.</li><li><em>Finanzen:</em> Zwei Anlagestrategien, die einzeln Geld verlieren, können – richtig kombiniert (Rebalancing) – positiv rentieren. Stichwort <em>Shannon's Demon</em>.</li><li><em>Diversifikation:</em> Volatile, antikorrelierte Assets mit negativem Erwartungswert können durch periodisches Umschichten Wert erzeugen.</li></ul><p>Parrondo & Harmer beschrieben das Paradoxon erst 1999 in <em>Nature</em> – seither wurde es in mehr als 1500 Arbeiten zitiert und auf Felder von Genetik bis Portfoliotheorie übertragen.</p>",
        "erkenntnis": "Die Eigenschaften eines Gesamtsystems lassen sich nicht aus dem Mittelwert seiner Teile ablesen. Verlierer + Verlierer kann Gewinner ergeben – wenn die Teile nicht unabhängig sind. Das ist die mathematische Begründung für Diversifikation, Rebalancing und sogar evolutionäre Innovation.",
    },
    "drei-gefangene": {
        "id": "drei-gefangene", "name": "Das Drei-Gefangenen-Problem", "icon": "⛓️",
        "farbe": "rose", "kategorie": "Wahrscheinlichkeit",
        "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Drei Gefangene – A, B und C – sitzen in Einzelhaft. Der Gouverneur hat einen von ihnen <strong>zufällig begnadigt</strong> (jede Person mit Wahrscheinlichkeit 1/3). Welcher, weiß nur der Wärter.<br><br>Gefangener A überlegt: „Meine Überlebenschance ist 1/3.\" Dann bittet er den Wärter um einen Hinweis: <em>„Sag mir wenigstens einen der anderen beiden, der hingerichtet wird. Da mindestens einer von B und C sterben muss, gibst du mir damit keine Information über mich.\"</em><br><br>Der Wärter überlegt kurz und sagt: <strong>„B wird hingerichtet.\"</strong><br><br>A jubelt: „Jetzt sind nur noch C und ich übrig – meine Chance ist also 1/2!\"",
        "frage": "Wie hoch ist As Überlebenschance jetzt wirklich?",
        "optionen": [
            {"text": "1/2 – nur noch zwei Kandidaten, also faire Aufteilung.", "hinweis": "Die intuitive Antwort fast aller Versuchspersonen"},
            {"text": "1/3 – wie zuvor, der Wärter hat A keine echte Information geliefert.", "hinweis": "Die Antwort von Bayes – aber wie verteilt sich der Rest?"},
            {"text": "2/3 – durch die Information hat sich seine Lage verbessert.", "hinweis": "Wäre das nicht eine Verwechslung mit Cs Chance?"},
            {"text": "Die Frage ist unentscheidbar ohne weitere Annahmen.", "hinweis": "Die Annahme braucht: Was tut der Wärter, wenn beide hingerichtet werden?"},
        ],
        "loesung_text": "As Überlebenschance bleibt bei 1/3 – aber Cs Chance steigt auf 2/3.",
        "erklaerung": "<p>Sei P(X) = Wahrscheinlichkeit, dass X begnadigt wird. Wir wissen: P(A) = P(B) = P(C) = 1/3. Wir wollen <strong>P(A | Wärter sagt „B\")</strong>.</p><p>Annahme zur Wärter-Strategie: Wenn <em>A</em> begnadigt ist, wählt er zufällig (50/50) zwischen „B\" und „C\".</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li>P(Wärter sagt „B\" | A begnadigt) = 1/2</li><li>P(Wärter sagt „B\" | B begnadigt) = 0 (er würde nie über den Begnadigten lügen)</li><li>P(Wärter sagt „B\" | C begnadigt) = 1 (er muss „B\" sagen, denn „C\" wäre die Antwort)</li></ul><p>Bayes:<br>P(A | „B\") = (1/2 · 1/3) / (1/2 · 1/3 + 0 · 1/3 + 1 · 1/3) = (1/6) / (1/2) = <strong>1/3</strong>.<br>P(C | „B\") = (1 · 1/3) / (1/2) = <strong>2/3</strong>.</p><p>Die Information aus dem Wärter-Statement <em>wirkt</em> – aber nicht symmetrisch. Sie verschiebt die ganze 1/3-Wahrscheinlichkeit von B auf C, nicht zur Hälfte auf A.</p>",
        "kontext": "<p>Das Problem wurde 1959 von Martin Gardner im <em>Scientific American</em> populär gemacht und ist mathematisch <strong>äquivalent zum Monty-Hall-Problem</strong>: Der Wärter „öffnet eine leere Tür\", wie der Moderator. „Wechseln\" entspricht hier dem Wechsel der Aufmerksamkeit von A auf C.</p><p>Die Intuition versagt, weil unser Gehirn nach dem Update naiv eine Gleichverteilung über die verbleibenden Optionen annimmt. Bayes zeigt: Das Update ist asymmetrisch, weil der Informant Regeln folgt – und seine Auswahl selbst <em>Information</em> trägt.</p><p>Übrigens: Hätte der Wärter eine andere Strategie (etwa: er sagt immer „B\", falls möglich), würde das Ergebnis sich ändern. Der Beobachter muss die Wahrscheinlichkeitsfunktion des Informanten kennen, um korrekt zu schließen – ein zentrales Thema in der Informations- und Auktionstheorie.</p>",
        "erkenntnis": "Wer Information bekommt, bekommt nicht nur Daten, sondern auch die Auswahlregel mitgeliefert – ob er sie kennt oder nicht. Bayes-Updates respektieren diese Asymmetrie; Intuition tut es selten.",
    },
    "schlaeger-ball": {
