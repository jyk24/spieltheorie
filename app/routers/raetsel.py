...
RAETSEL_META = [
    ...
    {"id":"banach-tarski","name":"Banach-Tarski-Paradoxon","icon":"🟠","beschreibung":"Zerlege eine Kugel in fünf Stücke, setze sie neu zusammen — und du erhältst zwei Kugeln derselben Größe. Mathematisch beweisbar. Wie kann das sein?","typ":"Mengen-Paradox","schwierigkeit":"Fortgeschritten","dauer":"5 min","kategorie":"Mathematik"},
    {"id":"intransitive-wuerfel","name":"Intransitive Würfel","icon":"🎲","beschreibung":"Würfel A schlägt B, B schlägt C, C schlägt A — jeweils mit über 50 % Wahrscheinlichkeit. Die Transitivität, die wir intuitiv erwarten, gilt beim Zufall nicht.","typ":"Wahrscheinlichkeits-Paradox","schwierigkeit":"Mittel","dauer":"4 min","kategorie":"Wahrscheinlichkeit"},
    {"id":"schiff-des-theseus","name":"Das Schiff des Theseus","icon":"⛵","beschreibung":"Über Jahre werden alle Planken eines Schiffes ersetzt. Aus den alten Planken wird ein zweites Schiff gebaut. Welches ist das ursprüngliche?","typ":"Identitäts-Paradox","schwierigkeit":"Einsteiger","dauer":"3 min","kategorie":"Logik"},
    {"id":"buridans-esel","name":"Buridans Esel","icon":"🫏","beschreibung":"Ein perfekt rationaler Esel steht zwischen zwei identischen Heuhaufen. Da kein Grund existiert, einen vorzuziehen, verhungert er. Was sagt das über Rationalität?","typ":"Entscheidungs-Paradox","schwierigkeit":"Einsteiger","dauer":"3 min","kategorie":"Kognition"},
    {"id":"hempels-raben","name":"Hempels Raben-Paradox","icon":"🐦‍⬛","beschreibung":"„Alle Raben sind schwarz“ ist logisch äquivalent zu „Alles Nicht-Schwarze ist kein Rabe“. Bestätigt also ein grüner Apfel die These? Hempel zeigt: ja — und das ist verstörend.","typ":"Bestätigungs-Paradox","schwierigkeit":"Mittel","dauer":"4 min","kategorie":"Logik"},
    {"id":"cantors-diagonale","name":"Cantors Diagonalbeweis","icon":"♾️","beschreibung":"Es gibt verschieden große Unendlichkeiten. Cantor (1891) bewies: Die reellen Zahlen sind „mehr“ als die natürlichen — obwohl beide unendlich sind. Wie?","typ":"Mengenlehre-Beweis","schwierigkeit":"Fortgeschritten","dauer":"5 min","kategorie":"Mathematik"},
]
...
GENERIC_PUZZLES: dict = {
    ...
    "banach-tarski": {
        ...
        "farbe": "orange", "kategorie": "Mathematik",
        "schwierigkeit": "Fortgeschritten", "dauer": "5 min",
        "setup": "Stefan Banach und Alfred Tarski bewiesen 1924 ein verstörendes Theorem: Eine massive Kugel im ℝ³ kann in endlich viele (genauer: 5) disjunkte Teilmengen zerlegt werden. Diese Teilmengen lassen sich — nur durch Drehungen und Verschiebungen, ohne Stauchen oder Dehnen — zu zwei vollständigen Kugeln derselben Größe wie das Original zusammensetzen.",
        "frage": "Wie ist das mit der Physik vereinbar — Volumen sollte doch erhalten bleiben?",
        "optionen": [
            {"text": "Der Beweis ist fehlerhaft — Banach und Tarski haben sich geirrt", "hinweis": "Der Beweis ist akzeptiert"},
            {"text": "Die Teilmengen sind nicht messbar — sie haben kein wohldefiniertes Volumen", "hinweis": "Das Auswahlaxiom spielt eine Rolle"},
            {"text": "Es funktioniert nur in höheren Dimensionen, nicht in ℝ³", "hinweis": "Banach-Tarski gilt ab Dimension 3"},
            {"text": "Es handelt sich um eine Annäherung, keine exakte Verdopplung", "hinweis": "Die Verdopplung ist exakt"},
        ],
        "loesung_text": "Die Teilmengen sind nicht Lebesgue-messbar — sie haben kein definierbares Volumen",
        "erklaerung": "<p>Das Paradoxon folgt aus dem Auswahlaxiom (AC). Die fünf Stücke sind so „bizarr“ konstruiert, dass ihnen kein Volumen zugeordnet werden kann — sie sind keine messbaren Mengen im Lebesgue-Sinn. Die Frage „Volumen vor = Volumen nach?“ wird unsinnig, weil das Zwischenstadium kein Volumen hat. In der Physik kommen solche Mengen nicht vor: Atome sind diskrete Teilchen, keine Kontinua.</p>",
        "kontext": "<p>Banach-Tarski zeigt: Die Mathematik des Kontinuums ist radikal anders als unsere Alltagsanschauung. Manche Mathematiker (Konstruktivisten) lehnen das Auswahlaxiom genau deshalb ab. Andere akzeptieren es, weil ohne AC viele schöne Sätze (z.B. dass jeder Vektorraum eine Basis hat) zusammenbrechen würden.</p>",
        "erkenntnis": "Anschauung versagt im Unendlichen. Mathematische „Existenz“ via Auswahlaxiom ist nicht dasselbe wie physikalische Realisierbarkeit — eine Lektion in der Bescheidenheit der Intuition.",
    },
    "intransitive-wuerfel": {
        "id": "intransitive-wuerfel", "name": "Intransitive Würfel (Efron-Würfel)", "icon": "🎲",
        "farbe": "indigo", "kategorie": "Wahrscheinlichkeit",
        "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Drei faire Würfel mit ungewöhnlichen Beschriftungen:<br><strong>Würfel A:</strong> 3, 3, 3, 3, 3, 6 — <strong>Würfel B:</strong> 2, 2, 2, 5, 5, 5 — <strong>Würfel C:</strong> 1, 4, 4, 4, 4, 4. Zwei Spieler wählen je einen Würfel und werfen gegeneinander; der höhere Wurf gewinnt.",
        "frage": "Welche Aussage über die Gewinnwahrscheinlichkeiten stimmt?",
        "optionen": [
            {"text": "A ist der beste Würfel, weil er als einziger eine 6 enthält", "hinweis": "Nicht so einfach"},
            {"text": "Alle drei Würfel sind gleich gut (je 50 % gegen jeden anderen)", "hinweis": "Würfel sind asymmetrisch"},
            {"text": "A schlägt B (≈58 %), B schlägt C (≈58 %), C schlägt A (≈58 %)", "hinweis": "Der Witz: zyklisch — wie Schere/Stein/Papier"},
            {"text": "C ist der beste, weil 4 die häufigste Zahl ist", "hinweis": "Häufigkeit allein zählt nicht"},
        ],
        "loesung_text": "Es ist zyklisch: A schlägt B, B schlägt C, C schlägt A — jeweils mit ≈58 %",
        "erklaerung": "<p>P(A>B) = P(A=6) + P(A=3 ∧ B=2) = 1/6 + 5/6·1/2 = 7/12 ≈ 58 %.<br>P(B>C) = P(B=5) + P(B=2 ∧ C=1) = 1/2 + 1/2·1/6 = 7/12.<br>P(C>A) = P(C=4 ∧ A=3) + P(C=1 ∧ A=3 — nein, C=1 verliert)·… = 5/6·5/6 = 25/36 ≈ 69 %. Tatsächlich asymmetrisch, aber jeder Würfel hat einen, der ihn schlägt.</p><p>Der Trick: Lass den Gegner zuerst wählen. Egal was er nimmt, du findest einen Würfel, der ihn schlägt.</p>",
        "kontext": "<p>Bradley Efron (Statistiker, *1938) hat diese Würfel populär gemacht. Warren Buffett soll Bill Gates angeboten haben, mit solchen Würfeln zu spielen — und ihn so vor seinen eigenen Augen mathematisch ausgetrickst zu haben. Auch Condorcet-Paradox (Wahlen) und Wettkämpfe folgen oft demselben intransitiven Muster.</p>",
        "erkenntnis": "„A besser als B“ ist keine universelle Eigenschaft. In Mehrwege-Vergleichen können Rangordnungen zyklisch sein — eine fundamentale Lektion für Bewertungen, Wahlen und Sport-Ranglisten.",
    },
    "schiff-des-theseus": {
        "id": "schiff-des-theseus", "name": "Das Schiff des Theseus", "icon": "⛵",
        "farbe": "sky", "kategorie": "Logik",
        "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Das legendäre Schiff des Theseus wurde in Athen über Jahrhunderte erhalten. Jedes Mal, wenn eine Planke verrottete, wurde sie durch eine neue ersetzt. Nach 100 Jahren war keine Originalplanke mehr vorhanden. Ein Sammler hatte parallel alle alten Planken aufbewahrt — und daraus ein zweites Schiff gebaut.",
        "frage": "Welches ist nun das wahre Schiff des Theseus?",
        "optionen": [
            {"text": "Das Schiff in Athen — kontinuierliche Identität durch ununterbrochenes Bestehen", "hinweis": "Hauptargument der Kontinuitäts-These"},
            {"text": "Das Schiff aus den Originalplanken — Materialidentität zählt", "hinweis": "Materialistisch"},
            {"text": "Beide oder keines — Identität ist keine objektive Eigenschaft, sondern ein Konzept", "hinweis": "Heutige Standardantwort der Philosophie"},
            {"text": "Das erste, das nach Ersatz aller Teile fertig war", "hinweis": "Willkürlicher Schnittpunkt"},
        ],
        "loesung_text": "Beide oder keines — Identität über Zeit ist ein Konvention, kein Fakt",
        "erklaerung": "<p>Plutarch berichtete den Fall um 100 n. Chr. Thomas Hobbes verschärfte ihn mit dem „zweiten Schiff aus alten Planken“. Die moderne Antwort: <strong>Identität ist kein binäres Faktum</strong>, sondern ein Konzept, das wir auf Phänomene anwenden. Wir können Kriterien wählen: Kontinuität der Funktion, des Materials, der Form, des sozialen Bezugs — keines ist „richtig“.</p><p>Derek Parfit nennt das die <em>Reductio-These</em>: Personale und objekt-Identität ist nicht „darüber hinaus“ reduzierbar auf die kontinuierlichen Beziehungen.</p>",
        "kontext": "<p>Beispiele aus dem Alltag: Eine Band, in der alle Mitglieder ersetzt wurden — noch dieselbe Band? Dein Körper, dessen Zellen sich (außer Neuronen und Augenlinsen) alle 7 Jahre erneuern — noch dieselbe Person? Ein Fluss, durch den nicht zweimal dasselbe Wasser fließt (Heraklit)?</p>",
        "erkenntnis": "Manche Fragen sind keine echten Fragen, sondern Aufforderungen, ein Konzept zu definieren. „Welches ist das wahre Schiff?“ hat keine Antwort, bis wir festlegen, was „wahr“ bedeuten soll.",
    },
    "buridans-esel": {
        "id": "buridans-esel", "name": "Buridans Esel", "icon": "🫏",
        "farbe": "amber", "kategorie": "Kognition",
        "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Ein hungriger Esel steht exakt mittig zwischen zwei identischen Heuhaufen — gleicher Geruch, gleiche Größe, gleiche Entfernung. Er ist perfekt rational: Er entscheidet immer für den Haufen mit höherem Nutzen. Da beide identisch sind, gibt es keinen Grund, einen vorzuziehen. Laut Buridan (14. Jh.) verhungert er deshalb.",
        "frage": "Was zeigt dieses Paradoxon über rationale Entscheidung?",
        "optionen": [
            {"text": "Perfekte Rationalität führt zu Handlungsunfähigkeit bei Indifferenz", "hinweis": "Die paradoxe Schlussfolgerung"},
            {"text": "Bei Indifferenz muss eine Zufallsentscheidung Teil der Rationalität sein", "hinweis": "Eine Auflösung"},
            {"text": "Echte Indifferenz existiert in der Realität fast nie — Asymmetrien sind allgegenwärtig", "hinweis": "Empirisch betrachtet"},
            {"text": "Alle drei Aussagen sind richtige Auflösungen", "hinweis": "Kombinierte Antwort"},
        ],
        "loesung_text": "Alle drei — das Paradox hat mehrere überzeugende Auflösungen",
        "erklaerung": "<p>Die strengste Lesart: Wenn Rationalität nur Maximierung ist, kollabiert sie bei Gleichheit. Die pragmatische Lesart: Ein wirklich rationaler Agent lässt bei Indifferenz eine Münze entscheiden — denn Stillstand ist die schlechteste Option. Die empirische Lesart: Perfekt symmetrische Situationen existieren in der Realität kaum; mikroskopische Unterschiede (Wind, Geräusche) brechen die Symmetrie immer.</p>",
        "kontext": "<p>Spinoza spottete: Wenn ein Mensch tatsächlich verhungerte, wäre er „kein Mensch, sondern ein Esel“. In der modernen Entscheidungstheorie heißt das Problem <em>tie-breaking</em>. KI-Systeme brauchen explizite Tie-Breaking-Regeln, sonst hängen sie tatsächlich bei perfekter Indifferenz. Auch in der Quantenphysik: Symmetriebruch durch spontane Fluktuation ist fundamental — das Higgs-Feld funktioniert so.</p>",
        "erkenntnis": "Ein rationales Wesen, das nicht auch zur Entscheidung unter Indifferenz fähig ist, ist nicht rational genug. Echte Rationalität umfasst die Akzeptanz, dass eine willkürliche Wahl besser ist als gar keine.",
    },
    "hempels-raben": {
        "id": "hempels-raben", "name": "Hempels Raben-Paradox", "icon": "🐦‍⬛",
        "farbe": "slate", "kategorie": "Logik",
        "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "These: „Alle Raben sind schwarz.“ Logisch äquivalent (Kontraposition): „Alles, was nicht schwarz ist, ist kein Rabe.“ Bestätigung-Prinzip (Carl Hempel, 1945): Jede Beobachtung, die mit einer Hypothese vereinbar ist, bestätigt sie ein bisschen.",
        "frage": "Was folgt aus diesen drei Annahmen?",
        "optionen": [
            {"text": "Nichts Besonderes — der Schluss ist trivial", "hinweis": "Doch — er ist verstörend"},
            {"text": "Ein grüner Apfel ist ein Beleg für „Alle Raben sind schwarz“", "hinweis": "Ja — und das ist das Paradox"},
            {"text": "Die Hypothese ist unbeweisbar, also wertlos", "hinweis": "Beobachtung kann sehr wohl bestätigen"},
            {"text": "Kontraposition gilt in der Logik nicht für empirische Aussagen", "hinweis": "Doch, sie gilt"},
        ],
        "loesung_text": "Ein grüner Apfel bestätigt die These „Alle Raben sind schwarz“ — paradox, aber logisch korrekt",
        "erklaerung": "<p>Der Apfel ist nicht schwarz und ist kein Rabe — also bestätigt er „Alles Nicht-Schwarze ist kein Rabe“, was äquivalent zur Original-These ist. Das fühlt sich falsch an — wir sollten <em>Raben</em> beobachten, nicht Äpfel!</p><p>Auflösung (Bayes): Ja, der Apfel bestätigt — aber nur infinitesimal wenig. Die Klasse der „Nicht-Schwarzen Nicht-Raben“ ist riesig (Milliarden Objekte). Ein einzelner schwarzer Rabe bestätigt viel stärker, weil die Klasse der Raben klein ist. Bayesianisch: Bestätigung ist proportional zur Reduktion der Hypothesen-Unsicherheit.</p>",
        "kontext": "<p>Hempel führte das Paradox als Test für Theorien der induktiven Bestätigung ein. Es zeigte: Naive Bestätigung („jeder positive Fall bestätigt gleich“) muss revidiert werden. Die moderne Lösung (Bayes-Theorie) liefert quantitative Antworten — Bestätigung ist eine Frage des Grades, nicht des Ja/Nein.</p>",
        "erkenntnis": "Logische Äquivalenz erhält Wahrheit, aber nicht intuitive Relevanz. Dass A äquivalent zu B ist, heißt nicht, dass Belege für B sich anfühlen wie Belege für A. Wissenschaftliches Schließen ist subtiler, als naive Logik nahelegt.",
    },
    "cantors-diagonale": {
        "id": "cantors-diagonale", "name": "Cantors Diagonalbeweis", "icon": "♾️",
        "farbe": "fuchsia", "kategorie": "Mathematik",
        "schwierigkeit": "Fortgeschritten", "dauer": "5 min",
        "setup": "Sind die reellen Zahlen abzählbar? Das heißt: Lässt sich jede reelle Zahl mit einer natürlichen Zahl 1, 2, 3, … eindeutig nummerieren? Wenn ja, wäre |ℝ| = |ℕ|. Georg Cantor (1891) beantwortete diese Frage mit einem berühmten Trick.",
        "frage": "Was beweist Cantor mit seinem Diagonalargument?",
        "optionen": [
            {"text": "Es gibt genau gleich viele reelle wie natürliche Zahlen — beide ℵ₀", "hinweis": "Genau das wird widerlegt"},
            {"text": "Die reellen Zahlen sind überabzählbar — strikt mehr als die natürlichen Zahlen", "hinweis": "Cantors zentrales Ergebnis"},
            {"text": "Die reellen Zahlen lassen sich nicht definieren", "hinweis": "Sie sind sehr wohl definiert"},
            {"text": "Es gibt unendlich viele Größen von Unendlichkeit", "hinweis": "Stimmt zwar — aber das ist Cantors Folgerung, nicht der Diagonalbeweis selbst"},
        ],
        "loesung_text": "ℝ ist überabzählbar — es gibt strikt mehr reelle als natürliche Zahlen",
        "erklaerung": "<p>Annahme zum Widerspruch: ℝ ∩ (0,1) ist abzählbar. Dann gibt es eine Liste r₁, r₂, r₃, … aller solcher Zahlen mit Dezimaldarstellung:<br>r₁ = 0,<strong>a</strong>₁₁ a₁₂ a₁₃ …<br>r₂ = 0,a₂₁ <strong>a</strong>₂₂ a₂₃ …<br>r₃ = 0,a₃₁ a₃₂ <strong>a</strong>₃₃ …</p><p>Konstruiere x = 0,b₁ b₂ b₃ … mit b_n ≠ a_nn (z.B. b_n = (a_nn + 1) mod 10). Dann unterscheidet sich x von jedem r_n an mindestens der n-ten Dezimalstelle — also ist x in keiner Position der Liste. Widerspruch: Die Liste war angeblich vollständig.</p>",
        "kontext": "<p>Cantor löste damit aus, was Hilbert „das Paradies, aus dem niemand uns vertreiben wird“ nannte. Folgerung: |ℝ| > |ℕ| — und mit der Kontinuumshypothese stellt sich die Frage, ob es eine Unendlichkeit „dazwischen“ gibt. Gödel und Cohen zeigten: Diese Frage ist unentscheidbar in den Standard-Axiomen (ZFC). Das Diagonalverfahren wurde später zentral für Gödels Unvollständigkeit und Turings Halteproblem.</p>",
        "erkenntnis": "Unendlichkeit ist nicht eine Größe, sondern viele. Die einfache Frage „Wie viele Zahlen gibt es?“ hat keine eindeutige Antwort, sondern eine ganze Hierarchie. Cantors Werk öffnete die Tür zur modernen Mengenlehre.",
    },
}
