...
RAETSEL_META = [
    ...
    {"id":"hyperbolisches-diskontieren","name":"Hyperbolisches Diskontieren","icon":"⏰","beschreibung":"100€ jetzt oder 110€ morgen? Fast alle wählen jetzt. Aber 100€ in 30 Tagen oder 110€ in 31 Tagen? Plötzlich ist Warten einfach. Warum sind wir bei naher Zukunft inkonsistent?","typ":"Temporal Discounting","schwierigkeit":"Mittel","dauer":"4 min","kategorie":"Psychologie"},
    {"id":"status-quo-bias","name":"Status-quo-Bias","icon":"🔒","beschreibung":"Opt-in vs. Opt-out: Deutschland hat 12% Organspender, Österreich 99%. Selbe Menschen, andere Voreinstellung. Was erklärt diesen dramatischen Unterschied?","typ":"Verhaltensökonomie","schwierigkeit":"Einsteiger","dauer":"3 min","kategorie":"Kognition"},
    {"id":"schelling-fokuspunkt","name":"Schelling-Fokuspunkte","icon":"📍","beschreibung":"Du musst dich mit einem Fremden in New York treffen – ohne Kommunikation. Wo und wann? Thomas Schelling (1960) zeigte: Menschen koordinieren intuitiv auf 'naheliegende' Lösungen.","typ":"Koordination","schwierigkeit":"Mittel","dauer":"4 min","kategorie":"Spieltheorie"},
    {"id":"hawthorne-effekt","name":"Der Hawthorne-Effekt","icon":"💡","beschreibung":"1924: Bessere Beleuchtung → mehr Produktion. Schlechtere Beleuchtung → auch mehr Produktion. Was erklärt diesen Widerspruch? Beobachtung verändert das Beobachtete.","typ":"Statistik-Paradox","schwierigkeit":"Einsteiger","dauer":"3 min","kategorie":"Statistik"},
    {"id":"mere-exposure","name":"Mere-Exposure-Effekt","icon":"🔁","beschreibung":"Ein fremdsprachiges Wort, das dir anfangs fremd ist, gefällt dir nach zehnmaliger Begegnung besser. Zajonc (1968): Bloße Wiederholung erzeugt Sympathie – selbst ohne Bewusstsein.","typ":"Wahrnehmungspsychologie","schwierigkeit":"Einsteiger","dauer":"3 min","kategorie":"Psychologie"},
    ...
    # ── Philosophie (Gedankenexperimente) ────────────────────────────────────
    {"id":"trolley-problem","name":"Das Trolley-Problem","icon":"🚋","beschreibung":"Eine Straßenbahn rast auf 5 Menschen zu. Du kannst eine Weiche umstellen – dann stirbt nur 1 Person. Darfst du? Philippa Foot (1967) eröffnete damit eine ganze Debatte der modernen Ethik.","typ":"Gedankenexperiment","schwierigkeit":"Einsteiger","dauer":"5 min","kategorie":"Philosophie"},
    {"id":"schiff-theseus","name":"Das Schiff des Theseus","icon":"🚢","beschreibung":"Über Jahre werden alle Planken eines Schiffes Stück für Stück ersetzt. Ist es dasselbe Schiff? Plutarchs uralte Frage berührt Identität, Personen und alle Dinge, die sich wandeln.","typ":"Identitäts-Paradox","schwierigkeit":"Mittel","dauer":"5 min","kategorie":"Philosophie"},
    {"id":"chinesisches-zimmer","name":"Das chinesische Zimmer","icon":"🀄","beschreibung":"Ein Mann in einem Raum folgt Regeln, um chinesische Zeichen zu beantworten – ohne ein Wort zu verstehen. Searles Einwand (1980) gegen 'starke KI': Syntax erzeugt keine Semantik. Stimmt das noch im Zeitalter der LLMs?","typ":"Gedankenexperiment","schwierigkeit":"Fortgeschritten","dauer":"6 min","kategorie":"Philosophie"},
    {"id":"schleier-nichtwissens","name":"Der Schleier des Nichtwissens","icon":"🎭","beschreibung":"Du entwirfst die Regeln einer Gesellschaft – weißt aber nicht, wer du darin sein wirst (reich, arm, krank, talentiert). Welche Gesellschaft wählst du? Rawls (1971) formulierte damit die Grundfrage gerechter Institutionen.","typ":"Fairness-Experiment","schwierigkeit":"Mittel","dauer":"5 min","kategorie":"Philosophie"},
    {"id":"erfahrungsmaschine","name":"Die Erfahrungsmaschine","icon":"🎮","beschreibung":"Eine Maschine kann dir jede beliebige Erfahrung perfekt simulieren – ein lebenslanges Glück. Würdest du dich anschließen? Nozicks Frage (1974) prüft, ob nur das subjektive Erleben zählt – oder ob Wirklichkeit selbst Wert hat.","typ":"Werte-Experiment","schwierigkeit":"Einsteiger","dauer":"4 min","kategorie":"Philosophie"},
]
...
GENERIC_PUZZLES: dict = {
    ...
    # ── Verhaltensökonomie & Entscheidung ────────────────────────────────────
    "sunk-cost": {
        "id": "sunk-cost", "name": "Der Sunk-Cost-Fehlschluss", "icon": "🎟️",
        "farbe": "rose", "kategorie": "Kognition", "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Du hast 80€ für eine Theaterkarte bezahlt. Nach der ersten Stunde ist das Stück furchtbar – du langweilst dich komplett. Draußen wartet dein Freund auf einen spontanen Kneipenabend.",
        "frage": "Was solltest du rational gesehen tun?",
        "optionen": [
            {"text": "Bleiben – du hast schließlich 80€ bezahlt", "hinweis": "Die 80€ sind unwiderruflich weg – egal was du jetzt tust"},
            {"text": "Gehen – die 80€ sind weg, aber die nächsten 2 Stunden noch nicht", "hinweis": "Sunk Costs sind irreversibel und für Entscheidungen irrelevant"},
            {"text": "Es kommt auf den Stimmungswert der Karte an", "hinweis": "Vergangenheit ist für künftige Entscheidungen irrelevant"},
            {"text": "Erst nach der Pause entscheiden", "hinweis": "Die Pause ändert nichts an der Grundlogik"},
        ],
        "loesung_text": "Gehen – versunkene Kosten sind für künftige Entscheidungen irrelevant",
        "erklaerung": "<p>Sunk Costs (versunkene Kosten) sind bereits bezahlte, nicht rückholbare Aufwände. Rational sind sie für künftige Entscheidungen irrelevant – sie können weder beeinflusst werden noch ändern sie den zukünftigen Nutzen einer Wahl.</p><p>Die einzige relevante Frage lautet: <em>Was bringt mir die nächste Stunde mehr Freude?</em> Die Vorgeschichte existiert für diese Frage nicht.</p>",
        "kontext": "<p>Klassische Sunk-Cost-Beispiele: Concorde (weitergebaut, obwohl unwirtschaftlich – 'wir haben schon so viel investiert'), Verlustpositionen im Portfolio ('ich kann nicht verkaufen, sonst realisiere ich den Verlust'), halbfertige Projekte ('wir haben schon 2 Jahre daran gearbeitet').</p><p>Der Fehlschluss entsteht aus dem Wunsch, Verluste psychologisch zu vermeiden und Konsistenz zu zeigen – beides menschliche Instinkte, die hier kontraproduktiv wirken.</p>",
        "erkenntnis": "Was bereits ausgegeben wurde, ist für künftige Entscheidungen nicht relevant. Die einzige Frage ist: Was bringt mir die Zukunft? – Nicht: Was hat mich die Vergangenheit gekostet?",
    },
    "verlustaversion": {
        "id": "verlustaversion", "name": "Verlustaversion", "icon": "⚖️",
        "farbe": "amber", "kategorie": "Kognition", "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Kahneman & Tversky (1979, Prospect Theory). Zwei Wetten mit gleichem Erwartungswert: A) Sicherer Gewinn 50€. B) 50% Chance auf 100€, sonst 0€. Dann – symmetrisch: C) Sicherer Verlust 50€. D) 50% Chance, 100€ zu verlieren, sonst nichts. Die meisten wählen A über B, aber D über C – obwohl das risikoinkonsistent ist.",
        "frage": "Was beschreibt Kahneman & Tverskys Prospect Theory über Verluste?",
        "optionen": [
            {"text": "Verluste und Gewinne werden gleich bewertet – Erwartungsnutzen gilt", "hinweis": "Widerspricht empirischen Befunden"},
            {"text": "Verluste wiegen psychologisch doppelt so schwer wie gleich große Gewinne", "hinweis": "Verlust-Koeffizient ≈ 2 laut Kahneman & Tversky"},
            {"text": "Gewinne werden stärker empfunden – wir sind von Natur aus optimistisch", "hinweis": "Umgekehrt – Verlustaversion dominiert"},
            {"text": "Menschen sind risikoneutral, solange Beträge klein sind", "hinweis": "Verlustaversion gilt für alle Größenordnungen"},
        ],
        "loesung_text": "Verluste fühlen sich doppelt so intensiv an wie gleich große Gewinne",
        "erklaerung": "<p>Die Wertfunktion der Prospect Theory ist asymmetrisch: 50€ zu verlieren fühlt sich so schlimm an wie ~100€ zu gewinnen sich gut anfühlt. Der empirisch gemessene Verlust-Koeffizient liegt bei ca. 2–2,5.</p><p>Das erklärt: Warum halten Anleger Verlustpositionen zu lange? Warum lehnen wir faire Wetten ab? Warum wirkt 'Preis steigt bald' stärker als 'Du sparst jetzt 20€'?</p>",
        "kontext": "<p>Prospect Theory ist die empirisch am besten bestätigte Alternative zur Erwartungsnutzentheorie. Kahneman erhielt 2002 den Wirtschaftsnobelpreis. In der Verhandlung: Frame Angebote als Vermeidung von Verlusten ('Ohne diesen Deal verlierst du X') statt als Gewinn ('Mit diesem Deal gewinnst du X'). Der Verlust-Frame wirkt ca. doppelt so stark.</p>",
        "erkenntnis": "Verluste fühlen sich stärker an als gleich große Gewinne. Dieser evolutionäre Schutzmechanismus führt zu systematischen Fehlentscheidungen – erkennbar in Investments, Verhandlungen und Alltagswahlentscheidungen.",
    },
    "hyperbolisches-diskontieren": {
        "id": "hyperbolisches-diskontieren", "name": "Hyperbolisches Diskontieren", "icon": "⏰",
        "farbe": "violet", "kategorie": "Psychologie", "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Zwei scheinbar identische Entscheidungen: (A) 100€ sofort oder 110€ in einer Woche? Fast alle: sofort. (B) 100€ in 30 Tagen oder 110€ in 31 Tagen? Jetzt wählen die meisten die 110€. In beiden Fällen ist die Entscheidung dieselbe – eine Woche warten für 10€ mehr.",
        "frage": "Was erklärt die Inkonsistenz?",
        "optionen": [
            {"text": "Risikoaversion: Heute sicher ist besser als morgen unsicher", "hinweis": "Erklärt A, aber nicht warum B anders ist"},
            {"text": "Hyperbolisches Diskontieren: Nahe Zukunft wird unverhältnismäßig stark abgezinst", "hinweis": "Kernmechanismus – Present Bias"},
            {"text": "Inflationserwartungen: 100€ heute sind objektiv mehr wert", "hinweis": "Gilt symmetrisch für A und B – erklärt die Inkonsistenz nicht"},
            {"text": "Vergesslichkeit: Wir trauen uns selbst nicht, 30 Tage zu warten", "hinweis": "Verwandt, aber nicht der theoretische Kern"},
        ],
        "loesung_text": "Hyperbolisches Diskontieren: Die nahe Zukunft wird überproportional stark abgezinst",
        "erklaerung": "<p>Rationale Akteure diskontieren exponentiell und konsistent – eine Woche Warten ist immer gleich 'teuer'. Menschen diskontieren aber hyperbolisch: Der erste Zeitabstand (0→1 Woche) fühlt sich viel bedeutender an als ein fernerer (30→31 Tage), obwohl beide gleich lang sind.</p><p>Das führt zu zeitlicher Inkonsistenz: Du planst, morgen früh anzufangen – aber wenn morgen kommt, ist übermorgen plötzlich genauso attraktiv.</p>",
        "kontext": "<p>Anwendungen: Prokrastination, Diäten ('ab Montag'), Sparverhalten, Sucht. Gegenmittel: Precommitment (Odysseus band sich an den Mast), Automatisierungen (Dauerauftrag), Kühlperioden. Present Bias erklärt, warum wir kurzfristige Konsequenzen systematisch übergewichten – auch wenn wir es besser wissen.</p>",
        "erkenntnis": "Der rationale Homo Economicus diskontiert gleichmäßig. Der echte Mensch überschätzt die nahe Zukunft massiv. Wer das erkennt, kann sich selbst klug binden – statt immer wieder in dieselbe Falle zu tappen.",
    },
    "status-quo-bias": {
        "id": "status-quo-bias", "name": "Status-quo-Bias", "icon": "🔒",
        "farbe": "sky", "kategorie": "Kognition", "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Johnson & Goldstein (2003, Science): In Ländern mit Opt-in-Organspende liegt die Spendenrate bei 4–27%. In Opt-out-Ländern: 85–99%. Deutschland: 12%. Österreich: 99%. Selbe Kultur, selbe Menschen – anderer Default.",
        "frage": "Was erklärt den dramatischen Unterschied?",
        "optionen": [
            {"text": "Österreicher haben andere ethische Werte gegenüber Organspende", "hinweis": "Keine belastbaren kulturellen Unterschiede belegt"},
            {"text": "Status-quo-Bias: Die Voreinstellung wird beibehalten, wenn aktives Handeln nötig wäre", "hinweis": "Kern des Phänomens – Trägheit + Default-Macht"},
            {"text": "Das Opt-out-Formular in Österreich ist besser gestaltet", "hinweis": "Design hilft, erklärt aber nicht den 87%-Unterschied"},
            {"text": "In Deutschland gibt es stärkeren religiösen Widerstand", "hinweis": "Erklärt keine 87%-Differenz"},
        ],
        "loesung_text": "Status-quo-Bias: Die Voreinstellung wird ohne aktiven Widerspruch beibehalten",
        "erklaerung": "<p>Menschen neigen dazu, die aktuelle Situation beizubehalten – selbst wenn aktive Veränderung besser wäre. Mechanismen: Trägheit (Handeln kostet Energie), Verlustaversion (Wechsel riskiert Verlust), implizite Norm ('das machen die meisten so').</p><p>Opt-out-Systeme nutzen diese Trägheit: Die Voreinstellung wird zur impliziten Empfehlung der Mehrheit.</p>",
        "kontext": "<p>Thaler & Sunstein (2008, 'Nudge'): Voreinstellungen sind keine neutrale Infrastruktur – sie sind politische Entscheidungen mit massiven Auswirkungen. Default-Rentenbeiträge bei Jobeintritt erhöhen die Sparquote dramatisch. Standard-Datenschutzeinstellungen bestimmen, wer deine Daten hat. Wer Entscheidungsarchitektur kontrolliert, beeinflusst Millionen – ohne Zwang.</p>",
        "erkenntnis": "Die Standardoption ist nie neutral – sie ist eine der mächtigsten Interventionen überhaupt. Wer Systeme entwirft, übernimmt Verantwortung. Wer sie nutzt, sollte die eigene Trägheit kennen.",
    },
    "schelling-fokuspunkt": {
        "id": "schelling-fokuspunkt", "name": "Schelling-Fokuspunkte", "icon": "📍",
        "farbe": "indigo", "kategorie": "Spieltheorie", "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Thomas Schelling fragte Yale-Studenten: 'Du musst dich morgen mit einem Fremden in New York treffen. Ihr habt keine Möglichkeit zu kommunizieren. Keine Adresse wurde vereinbart. Wo triffst du dich – und wann?' Schelling (1960, The Strategy of Conflict) erwartete keine Koordination.",
        "frage": "Was fand Schelling heraus?",
        "optionen": [
            {"text": "Zufällige Streuung – es gibt keinen rationalen Koordinationspunkt", "hinweis": "Das Gegenteil war der Fall"},
            {"text": "Die meisten Teilnehmer koordinierten spontan auf denselben Ort und dieselbe Zeit", "hinweis": "Grand Central Station, 12 Uhr – kulturell hervorstechend"},
            {"text": "Koordination ohne Kommunikation ist mathematisch unmöglich", "hinweis": "Schelling widerlegte das empirisch"},
            {"text": "Jeder wählte seinen bevorzugten Ort – keine Übereinstimmung", "hinweis": "Überraschend hohe Koordination war das Ergebnis"},
        ],
        "loesung_text": "Die meisten koordinierten auf Grand Central Station, 12 Uhr Mittag",
        "erklaerung": "<p>Schelling-Punkte (Fokuspunkte) sind Lösungen, die durch Bekanntheit, Symmetrie oder kulturelle Hervorhebung 'natürlich' wirken – ohne explizite Vereinbarung. Mechanismus: Ich wähle, was du wählen würdest – wenn du weißt, dass ich wähle, was du wählst. Diese Rekursion konvergiert auf das 'auffälligste' Objekt.</p>",
        "kontext": "<p>Schelling-Punkte erklären: Preisgestaltung (runde Zahlen als Verhandlungsanker), Waffenstillstandslinien (Flüsse, Grenzen), Marktkoordination ohne Kartell, Sprachkonventionen, soziale Normen als implizite Koordination. Schelling erhielt 2005 den Wirtschaftsnobelpreis für Konflikt- und Kooperationstheorie.</p>",
        "erkenntnis": "Menschen koordinieren intuitiv auf 'hervorstechende' Lösungen – ohne Absprache. Wer versteht, was in einer Situation als Fokuspunkt wirkt, kann besser signalisieren, verhandeln und kooperieren.",
    },
    "hawthorne-effekt": {
        "id": "hawthorne-effekt", "name": "Der Hawthorne-Effekt", "icon": "💡",
        "farbe": "amber", "kategorie": "Statistik", "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Hawthorne Works, Chicago (1924–1932): Forscher verbesserten die Fabrikbeleuchtung – Produktivität stieg. Zur Kontrolle verschlechterten sie die Beleuchtung – Produktivität stieg erneut. Jede Veränderung führte zu mehr Leistung, unabhängig von der Richtung.",
        "frage": "Was erklärt dieses Muster?",
        "optionen": [
            {"text": "Beleuchtungsänderungen verbessern immer die Konzentration", "hinweis": "Widerspricht sich: Beide Richtungen halfen gleich"},
            {"text": "Die Arbeiter wussten, dass sie beobachtet wurden – und verhielten sich anders", "hinweis": "Beobachtung selbst verändert Verhalten"},
            {"text": "Zufällige Variation – keine kausale Erklärung nötig", "hinweis": "Das Muster war zu konsistent und wiederholt"},
            {"text": "Abwechslung im Alltag steigert vorübergehend die Motivation", "hinweis": "Teilweise richtig, aber nicht der Kerneffekt"},
        ],
        "loesung_text": "Beobachtung selbst verändert das beobachtete Verhalten",
        "erklaerung": "<p>Der Hawthorne-Effekt: Menschen verhalten sich anders, wenn sie wissen, dass sie beobachtet werden – unabhängig von der eigentlichen Intervention. Das stellt die Kausalinterpretation vieler Studien grundlegend in Frage: Zeigt das Ergebnis die Wirkung der Maßnahme – oder die Wirkung der Beobachtung?</p>",
        "kontext": "<p>Kernproblem der empirischen Sozialwissenschaft. Gegenmaßnahmen: Doppelblindstudien, Kontrollgruppen ohne Wissen der Teilnehmer, Langzeitstudien (Effekt verblasst). Paradoxerweise ist der Hawthorne-Effekt manchmal nützlich: Allein das Messen von Mitarbeiterzufriedenheit kann sie verbessern – weil es Aufmerksamkeit signalisiert.</p>",
        "erkenntnis": "Messen ist nicht neutral. Wer gemessen wird, ändert sein Verhalten. Das macht Kausalanalyse in sozialen Systemen schwer – aber auch bewusste Aufmerksamkeit zu einem Gestaltungswerkzeug.",
    },
    "mere-exposure": {
        "id": "mere-exposure", "name": "Mere-Exposure-Effekt", "icon": "🔁",
        "farbe": "emerald", "kategorie": "Psychologie", "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Robert Zajonc (1968): Versuchspersonen wurden chinesische Schriftzeichen gezeigt – einige häufiger als andere. Danach wurden sie nach Präferenzen gefragt. Sie kannten die Bedeutung keiner Zeichen. Trotzdem hatten sie klare Favoriten – die konsistent mit der Häufigkeit der Darbietung korrelierten.",
        "frage": "Was erklärt diese Präferenzen?",
        "optionen": [
            {"text": "Ästhetik: Manche Zeichen sind objektiv schöner", "hinweis": "Dann würde Häufigkeit keine Rolle spielen"},
            {"text": "Bloße Wiederholung erzeugt Sympathie – unabhängig von Inhalt oder Bewertung", "hinweis": "Mere Exposure Effect – Kernbefund Zajoncs"},
            {"text": "Seltenheit macht attraktiv – was man seltener sieht, wirkt exklusiver", "hinweis": "Gegenteil des Befunds"},
            {"text": "Confirmation Bias: Positive Ersterfahrung wurde bestätigt", "hinweis": "Es gab keine Ersterfahrung mit Bedeutung"},
        ],
        "loesung_text": "Bloße Wiederholung erzeugt Sympathie – auch vollständig unbewusst",
        "erklaerung": "<p>Zajoncs Kernbefund: Allein das Ausgesetztsein (Exposure) genügt, um positive Bewertung zu erzeugen – ohne Lernen, Bewertung oder Kontext. Je häufiger ein Stimulus auftaucht, desto positiver wird er bewertet. Das gilt für Wörter, Gesichter, Musik, Produkte, Marken.</p>",
        "kontext": "<p>Mere Exposure erklärt: Werbung durch Wiederholung (auch unbeliebte Werbung erzeugt Markenbekanntheit), vertraute Gesichter sind sympathischer (Amtsbonus in der Politik), Popsongs gefallen nach dem 20. Hören besser. Grenze: Bei negativem Ersterleben verstärkt Wiederholung die Abneigung. Der Effekt wirkt am stärksten unterhalb der Bewusstseinsschwelle.</p>",
        "erkenntnis": "Vertrautheit erzeugt Sympathie – fast automatisch. Das macht Wiederholung zu einem der wirkungsvollsten (und am wenigsten bewussten) Überzeugungswerkzeuge überhaupt.",
    },
    "goodharts-gesetz": {
        "id": "goodharts-gesetz", "name": "Goodharts Gesetz", "icon": "📏",
        "farbe": "rose", "kategorie": "Statistik", "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Charles Goodhart (1975): Als die britische Zentralbank begann, bestimmte Geldmengengrößen zu steuern, hörten die Korrelationen zu realen Wirtschaftsgrößen auf zu funktionieren. Dasselbe passiert in Schulen (PISA-Rankings), Krankenhäusern (Wartezeiten), Unternehmen (Quarterly Earnings) und der Wissenschaft (Impact Factor).",
        "frage": "Was ist der Kernmechanismus?",
        "optionen": [
            {"text": "Metriken veralten – was 1975 galt, gilt 2025 nicht mehr", "hinweis": "Stimmt teilweise, aber nicht der spezifische Mechanismus"},
            {"text": "Wenn ein Maß zum Ziel wird, verliert es seine Aussagekraft – Akteure optimieren auf das Maß statt auf das Phänomen", "hinweis": "Klassische Goodhart-Formulierung"},
            {"text": "Quantifizierung zerstört intrinsische Motivation", "hinweis": "Verwandt (Overjustification Effect), aber unterschiedlich"},
            {"text": "Bürokratien sind ineffizient – Ziele werden nie erreicht", "hinweis": "Zu allgemein – beschreibt keinen Mechanismus"},
        ],
        "loesung_text": "Das Ziel korrumpiert das Maß: Optimierung für den Indikator zerstört seine Aussagekraft",
        "erklaerung": "<p>Wenn ein Indikator zum Optimierungsziel wird, beginnen Akteure direkt auf den Indikator zu optimieren – statt auf das zugrundeliegende Phänomen. Der Indikator verbessert sich, das Phänomen nicht.</p><p>Klassisch: Sowjetische Nagelfabriken mit Stückzahl-Quote produzierten tausende winzige Nägel. Mit Gewichts-Quote: einen riesigen Nagel.</p>",
        "kontext": "<p>Verwandte Konzepte: Cobra-Effekt (Kolonialregierungen belohnten tote Kobras → Farmer züchteten Kobras), McNamara-Fehlschluss (Körperzahlen als Kriegs-KPI im Vietnamkrieg), Campbell's Law (1976, unabhängige Formulierung für Sozialindikatoren). Goodharts Gesetz gilt überall, wo Metriken zur Leistungsbewertung eingesetzt werden.</p>",
        "erkenntnis": "Keine Metrik ist immun gegen Optimierung – sobald sie zum Ziel wird. Wer Systeme entwirft, braucht mehrere unkorrelierte Maße und muss verstehen: Was liegt hinter der Zahl?",
    },
    "nudging": {
        "id": "nudging", "name": "Nudging", "icon": "👉",
        "farbe": "teal", "kategorie": "Kognition", "schwierigkeit": "Einsteiger", "dauer": "3 min",
        "setup": "Richard Thaler & Cass Sunstein (2008, 'Nudge'): Eine Schulkantine stellt Obst auf Augenhöhe, Desserts ins untere Regal. Keine Verbote, keine Preisveränderungen. Ergebnis: Obstverkauf +25%. Thaler nannte das 'Libertären Paternalismus' – Wahlfreiheit bleibt, aber Kontext wird optimiert.",
        "frage": "Was ist das Kernprinzip von Nudging?",
        "optionen": [
            {"text": "Bessere Information: Wer mehr weiß, entscheidet besser", "hinweis": "Nudges wirken auch ohne Wissen und Bewusstsein"},
            {"text": "Entscheidungsarchitektur: Die Gestaltung des Kontexts lenkt Verhalten – ohne Wahlfreiheit zu beschränken", "hinweis": "Libertärer Paternalismus – Freiheit bleibt, Kontext wird gestaltet"},
            {"text": "Nudges wirken nur, wenn man sie nicht bemerkt", "hinweis": "Nudges wirken auch dann, wenn man sie kennt"},
            {"text": "Finanzielle Mikro-Anreize in unsichtbarer Form", "hinweis": "Ausdrücklich ohne finanzielle Anreize definiert"},
        ],
        "loesung_text": "Entscheidungsarchitektur: Kontext lenkt Verhalten ohne Zwang oder finanzielle Anreize",
        "erklaerung": "<p>Nudging nutzt vorhersehbare kognitive Biases aus (Status-quo-Bias, Availability Heuristic, Social Proof), um wünschenswertes Verhalten zu fördern. Statt Menschen zu zwingen oder zu bestechen, wird der Entscheidungskontext so gestaltet, dass die 'bessere' Wahl die einfachere ist.</p>",
        "kontext": "<p>Thaler erhielt 2017 den Wirtschaftsnobelpreis. Anwendungen: Rentenspar-Defaults, Energiespar-Hinweise mit sozialen Vergleichen ('Deine Nachbarn verbrauchen X% weniger'), Gesundheitsverhalten, Steuererklärungen. Kritik: Wer entscheidet, was 'besser' ist? Transparenz über Nudge-Design ist ethisch erforderlich.</p>",
        "erkenntnis": "Kontext ist nie neutral – er lenkt immer. Wer das nicht aktiv gestaltet, überlässt die Gestaltung dem Zufall oder kommerziellen Interessen. Bewusstes Nudge-Design ist eine Frage der Verantwortung.",
    },
    "zentraler-grenzwertsatz": {
        "id": "zentraler-grenzwertsatz", "name": "Zentraler Grenzwertsatz", "icon": "🔔",
        "farbe": "violet", "kategorie": "Mathematik", "schwierigkeit": "Mittel", "dauer": "4 min",
        "setup": "Wirf einen Würfel einmal: flache Gleichverteilung über 1–6. Wirf ihn 2 Mal und nimm den Durchschnitt: leichte Zeltform. Wirf ihn 30 Mal und nimm den Durchschnitt: nahezu perfekte Glockenkurve. Das Ausgangsmaterial war gleichverteilt – die Glockenkurve entstand dennoch.",
        "frage": "Was besagt der Zentrale Grenzwertsatz?",
        "optionen": [
            {"text": "Alle echten Zufallsprozesse sind normalverteilt", "hinweis": "Nein – die Originalverteilung kann beliebig sein"},
            {"text": "Der Mittelwert vieler unabhängiger Zufallsvariablen konvergiert zur Normalverteilung – egal wie die Originalverteilung aussieht", "hinweis": "Kern des ZGS – Laplace 1812"},
            {"text": "Normalverteilung entsteht nur bei symmetrischen Ausgangsprozessen", "hinweis": "Gilt auch für schiefe Verteilungen – bei genug n"},
            {"text": "Mit mehr Daten wird die Stichprobe repräsentativer", "hinweis": "Wahr, aber nicht der ZGS"},
        ],
        "loesung_text": "Der Mittelwert vieler unabhängiger Stichproben konvergiert zur Normalverteilung – unabhängig von der Originalverteilung",
        "erklaerung": "<p>ZGS (Laplace, 1812): Wenn n unabhängige, identisch verteilte Zufallsvariablen mit endlicher Varianz summiert oder gemittelt werden, konvergiert ihre Verteilung für großes n gegen eine Normalverteilung – egal wie die Originalverteilung aussah.</p><p>Das erklärt, warum so viele natürliche Phänomene annähernd normalverteilt sind (Körpergröße, Messfehler, IQ-Scores): Sie sind Summen vieler kleiner unabhängiger Einflüsse.</p>",
        "kontext": "<p>Praktische Bedeutung: Statistische Tests (t-Test, z-Test, ANOVA) setzen Normalverteilung der Mittelwerte voraus – nicht der Rohdaten. Der ZGS rechtfertigt das für große Stichproben. Grenzen: Nicht-endliche Varianz (Cauchy-Verteilung), abhängige Variablen (Finanzmärkte), sehr kleine n bei stark schiefen Ausgangsdaten.</p>",
        "erkenntnis": "Die Normalverteilung entsteht nicht durch Zufall – sondern durch Aggregation. Das Zusammenspiel vieler unabhängiger Faktoren erzeugt Glockenform. Wer das versteht, weiß wann statistische Tests gelten – und wann nicht.",
    },
    # ─────────────────────────────────────────────────────────────────────────
    "milgram-gehorsam": {
    ...
    # ── Philosophie: Gedankenexperimente ──────────────────────────────────
    "trolley-problem": {
        "id": "trolley-problem", "name": "Das Trolley-Problem", "icon": "🚋",
        "farbe": "rose", "kategorie": "Philosophie",
        "schwierigkeit": "Einsteiger", "dauer": "5 min",
        "setup": "Eine außer Kontrolle geratene Straßenbahn rast auf <strong>5 Gleisarbeiter</strong> zu. Du stehst neben einer Weiche. Wenn du sie umstellst, lenkt das den Wagen auf ein Nebengleis – dort steht <strong>1 einzelner Arbeiter</strong>. Niemand kann gewarnt werden.",
        "frage": "Was ist moralisch zulässig – die Weiche umstellen oder nicht?",
        "optionen": [
            {"text": "Weiche umstellen: 1 Tod statt 5 ist offensichtlich besser", "hinweis": "Utilitaristische Logik"},
            {"text": "Weiche nicht umstellen: aktive Tötung ist immer falsch", "hinweis": "Deontologische Position"},
            {"text": "Es kommt darauf an, wer der eine ist", "hinweis": "Situationsethik"},
            {"text": "Es gibt keine richtige Antwort – beides ist moralisch verboten", "hinweis": "Tragische Wahl"},
        ],
        "loesung_text": "Die meisten halten Umlenken für zulässig – aber das Variantenpuzzle zeigt, dass unsere Intuitionen widersprüchlich sind.",
        "erklaerung": "<p><strong>Standard-Fall (Weiche):</strong> ~85–90% der Befragten finden Umlenken moralisch zulässig.</p><p><strong>Brücken-Variante:</strong> Du stehst auf einer Brücke neben einem dicken Mann. Wenn du ihn hinunter stößt, stoppt sein Körper die Bahn und rettet die 5. Nur ~10–30% halten <em>das</em> für zulässig – obwohl die Bilanz identisch ist (1 Tod, 5 Leben gerettet).</p><p>Was unterscheidet beide Fälle? Philosophen identifizieren mehrere Faktoren: <em>aktive vs. passive Nutzung</em> der Person als Mittel (Kants Imperativ), <em>physische Nähe</em>, <em>vorhergesehene vs. beabsichtigte</em> Schadensfolge (Doktrin der Doppelwirkung).</p>",
        "kontext": "<p><strong>Philippa Foot</strong> formulierte das Original 1967 in einem Aufsatz über Abtreibung. <strong>Judith Jarvis Thomson</strong> erweiterte es 1985 mit der Brücken-Variante. Seitdem ist das Trolley-Problem ein Stresstest für ethische Theorien:</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>Utilitarismus</strong> (Bentham, Mill): Maximiere das Wohl – also umlenken <em>und</em> stoßen.</li><li><strong>Deontologie</strong> (Kant): Menschen niemals nur als Mittel benutzen – also nicht stoßen, aber Umlenken ist Grenzfall.</li><li><strong>Tugendethik</strong> (Aristoteles): Was würde ein guter Mensch tun? – Antwort kontextabhängig.</li></ul><p>Moderne Anwendung: <strong>Selbstfahrende Autos</strong>. Ein MIT-Experiment (<em>Moral Machine</em>, 40 Mio. Antworten aus 233 Ländern) zeigte massive kulturelle Unterschiede darüber, wessen Leben in unvermeidlichen Crashs Vorrang haben sollte.</p>",
        "erkenntnis": "Moralische Intuitionen sind nicht konsistent. Wer Ethik ernst nimmt, muss bereit sein, entweder seine Intuition oder seine Theorie zu revidieren – das ist die eigentliche Lehre aller guten Gedankenexperimente.",
    },
    "schiff-theseus": {
        "id": "schiff-theseus", "name": "Das Schiff des Theseus", "icon": "🚢",
        "farbe": "cyan", "kategorie": "Philosophie",
        "schwierigkeit": "Mittel", "dauer": "5 min",
        "setup": "Das Schiff, mit dem Theseus aus Kreta zurückkehrte, wurde von den Athenern jahrhundertelang erhalten. <strong>Jede morsche Planke</strong> wurde nach und nach durch eine neue ersetzt. Nach 300 Jahren ist <strong>kein einziges Originalteil</strong> mehr übrig.<br><br>Thomas Hobbes (1655) erweiterte: Was, wenn jemand alle alten Planken sammelt und daraus ein <strong>zweites Schiff</strong> baut?",
        "frage": "Welches Schiff ist das echte Schiff des Theseus?",
        "optionen": [
            {"text": "Das renovierte Schiff (Kontinuität)", "hinweis": "Identität durch ununterbrochene Funktion"},
            {"text": "Das rekonstruierte Schiff (Originalmaterial)", "hinweis": "Identität durch Substanz"},
            {"text": "Beide oder keines – Identität ist hier nicht eindeutig definiert", "hinweis": "Es gibt kein 'objektives' Kriterium"},
            {"text": "Das ist eine sinnlose Frage", "hinweis": "Ist sie wirklich sinnlos?"},
        ],
        "loesung_text": "Die meisten Philosophen sehen darin echte Mehrdeutigkeit – Identität ist nicht eine, sondern mehrere Eigenschaften.",
        "erklaerung": "<p>Das Paradox zwingt uns zur Frage: <strong>Was macht ein Ding zu demselben Ding über die Zeit?</strong> Mindestens drei Kriterien konkurrieren:</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>Materielle Kontinuität</strong> (gleicher Stoff) → das rekonstruierte Schiff gewinnt</li><li><strong>Räumlich-funktionale Kontinuität</strong> (ununterbrochener Gebrauch) → das renovierte gewinnt</li><li><strong>Form/Struktur</strong> (gleicher Bauplan) → beide gewinnen</li></ul><p>Wenn nur ein Schiff existieren würde, hätte niemand ein Problem damit, es als 'dasselbe' anzusehen. Erst die Konfrontation mit dem zweiten Kandidaten zeigt: Unsere Identitätsbegriffe sind <em>nicht für Konfliktfälle</em> gebaut.</p>",
        "kontext": "<p>Das Schiff ist nur die Spitze des Eisbergs. Dieselbe Frage gilt für:</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>Menschliche Zellen</strong>: Fast jede Zelle deines Körpers wird in 7–10 Jahren ersetzt. Bist du noch derselbe Mensch?</li><li><strong>Personale Identität</strong> (Locke 1689): Was macht <em>mich</em> über die Zeit zu mir? Antwort: Erinnerung, also psychologische Kontinuität.</li><li><strong>Star-Trek-Beamer-Paradox</strong> (Parfit 1984): Wenn dein Körper zerlegt und identisch wiederaufgebaut wird – bist <em>du</em> dort angekommen?</li><li><strong>Organisationen</strong>: Ist die Firma, in der niemand mehr von 1950 arbeitet, noch dieselbe?</li></ul><p>Derek Parfit (<em>Reasons and Persons</em>, 1984) zog daraus: <strong>Personale Identität ist nicht das, was wichtig ist</strong>. Was zählt, sind psychologische Verbindungen – und die kommen in Grade vor, nicht binär.</p>",
        "erkenntnis": "Viele unserer Begriffe (Identität, Eigentum, Selbst) wirken eindeutig, bis ein cleverer Fall sie sprengt. Begriffe sind Werkzeuge – sie taugen für ihre üblichen Anwendungen, müssen aber an Grenzfällen revidiert werden.",
    },
    "chinesisches-zimmer": {
        "id": "chinesisches-zimmer", "name": "Das chinesische Zimmer", "icon": "🀄",
        "farbe": "amber", "kategorie": "Philosophie",
        "schwierigkeit": "Fortgeschritten", "dauer": "6 min",
        "setup": "Du sitzt allein in einem Raum. Durch einen Schlitz kommen Zettel mit <strong>chinesischen Schriftzeichen</strong>, die du nicht verstehst. Du hast aber ein <strong>riesiges Regelbuch</strong> (auf Deutsch), das dir sagt: 'Bei Eingabe X gib Ausgabe Y zurück.' Du folgst nur den Regeln.<br><br>Die Menschen draußen sind <strong>Muttersprachler des Chinesischen</strong>. Sie senden Fragen, empfangen deine Antworten – und sind überzeugt: <em>'Da drinnen sitzt jemand, der perfekt Chinesisch versteht.'</em>",
        "frage": "Verstehst du Chinesisch?",
        "optionen": [
            {"text": "Ja – wer eine Sprache perfekt antwortet, versteht sie", "hinweis": "Turing-Test-Logik"},
            {"text": "Nein – ich manipuliere nur Symbole nach Regeln", "hinweis": "Searles eigene Antwort"},
            {"text": "Das ganze System (Raum + Buch + ich) versteht Chinesisch", "hinweis": "Systems Reply – die Standardgegenposition"},
            {"text": "Die Frage ist nicht entscheidbar", "hinweis": "Behaviouristische Position"},
        ],
        "loesung_text": "Searle: Nein. Die meisten KI-Forscher: Es kommt darauf an, wie man 'Verstehen' definiert.",
        "erklaerung": "<p><strong>John Searle</strong> entwarf das Experiment 1980 als Angriff auf <em>starke KI</em>: die These, ein Computer, der das Richtige tut, <em>versteht</em> auch wirklich. Searle argumentiert: <strong>Syntax (Symbolregeln) genügt nicht für Semantik (Bedeutung)</strong>. Der Mann manipuliert Zeichen – das tut ein Computer auch.</p><p>Die berühmteste Gegenposition ist die <strong>Systems Reply</strong>: Nicht der Mann versteht, sondern das ganze System aus Mann + Regelbuch + Datenbank + Zettel. Searle kontert: Wenn der Mann das gesamte Regelbuch auswendig lernt und ins Freie geht, ist <em>er</em> das System – versteht er dann Chinesisch? Er antwortet: nein.</p><p>Weitere Gegenargumente:</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>Robot Reply</strong>: Mit Sensoren und Motoren entstünde echte Bedeutungsverbindung.</li><li><strong>Brain Simulator Reply</strong>: Wenn das Regelbuch ein chinesisches Gehirn neuronengetreu simuliert, müsste es verstehen.</li></ul>",
        "kontext": "<p><strong>Im Zeitalter der LLMs</strong> ist das Argument explosiver denn je. GPT-4 oder Claude bestehen praktisch jeden Turing-Test – produzieren Texte, die von menschlichen Antworten ununterscheidbar sind. <em>Verstehen</em> sie?</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>Searles Lager</strong>: Nein. Statistische Mustervorhersage ist nicht Bedeutung.</li><li><strong>Funktionalisten</strong>: Wenn ein System sich in jeder Hinsicht verstehend verhält, ist es nicht prinzipiell von Verstehen unterscheidbar.</li><li><strong>Pragmatiker</strong>: Die Frage ist nicht entscheidbar – aber praktisch unwichtig, solange das Verhalten stimmt.</li></ul><p>Das Experiment hat tiefe Implikationen für KI-Ethik, Bewusstseinsforschung und die Frage, wann Maschinen moralisch relevant sind.</p>",
        "erkenntnis": "Wir wissen nicht zuverlässig, ob ein System 'versteht' oder 'fühlt' – wir schließen nur aus Verhalten. Das ist bei anderen Menschen genauso (Problem fremder Bewusstseine). Vielleicht ist 'Verstehen' weniger ein scharfer Begriff als ein Bündel von Fähigkeiten – die graduell vorkommen.",
    },
    "schleier-nichtwissens": {
        "id": "schleier-nichtwissens", "name": "Der Schleier des Nichtwissens", "icon": "🎭",
        "farbe": "violet", "kategorie": "Philosophie",
        "schwierigkeit": "Mittel", "dauer": "5 min",
        "setup": "Stell dir vor, du entwirfst die <strong>Grundregeln einer Gesellschaft</strong> – Steuersätze, Bildungssystem, Justiz, Sozialleistungen. Aber: Du sitzt hinter einem <strong>'Schleier des Nichtwissens'</strong>. Du weißt nicht:<br><br>• ob du reich oder arm geboren wirst<br>• ob du gesund oder krank bist<br>• ob du talentiert oder durchschnittlich bist<br>• welche Hautfarbe, Religion, welches Geschlecht du hast<br><br>Alle anderen Designer haben denselben Schleier. Ihr müsst Regeln finden, denen alle zustimmen.",
        "frage": "Welche Art Gesellschaft wählst du wahrscheinlich?",
        "optionen": [
            {"text": "Maximaler Gesamtnutzen (Utilitarismus) – egal wie ungleich verteilt", "hinweis": "Riskant, wenn du unten landest"},
            {"text": "Ein System, das die Position der Schlechtesten maximiert", "hinweis": "Rawls' 'Differenzprinzip'"},
            {"text": "Strikte Gleichheit für alle", "hinweis": "Schließt Anreize aus"},
            {"text": "Reine Marktwirtschaft – wer arbeitet, gewinnt", "hinweis": "Riskant ohne Sicherheitsnetz"},
        ],
        "loesung_text": "Rawls argumentiert: Rationale Risikoscheue Personen wählen ein System, das die Position der Schlechtesten maximiert.",
        "erklaerung": "<p><strong>John Rawls</strong> (<em>A Theory of Justice</em>, 1971) leitete aus diesem Gedanken zwei Grundprinzipien ab:</p><ol class=\"list-decimal ml-4 mt-2 space-y-1 text-sm\"><li><strong>Gleiche Grundfreiheiten</strong>: Jede Person hat denselben Anspruch auf grundlegende Freiheiten (Meinung, Religion, politische Teilhabe).</li><li><strong>Differenzprinzip</strong>: Soziale und ökonomische Ungleichheiten sind nur dann gerecht, wenn sie auch der schlechtest gestellten Gruppe maximalen Vorteil bringen.</li></ol><p>Begründung: Hinter dem Schleier weißt du nicht, ob du Bill Gates oder ein obdachloser Mensch in Bangladesch sein wirst. Rationale Risikoaversion sagt: <em>Wähle Regeln, mit denen du auch im schlechtesten Fall noch leben kannst.</em> Das ist die Logik der <strong>Maximin-Strategie</strong>.</p>",
        "kontext": "<p>Das Experiment ist nicht nur Theorie – es liefert ein operatives Werkzeug für Gerechtigkeitsfragen:</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>Steuerpolitik</strong>: Würdest du progressive Steuern wollen, ohne zu wissen, wie viel du verdienst?</li><li><strong>Klimapolitik</strong>: Was wäre 'fair' zwischen jetzt lebenden und zukünftigen Generationen?</li><li><strong>Künstliche Intelligenz</strong>: Welche Regeln für KI-Systeme würdest du wollen, ohne zu wissen, ob du der Programmierer, Nutzer oder Betroffener bist?</li></ul><p><strong>Kritik</strong> kam vor allem von Robert Nozick (<em>Anarchy, State, and Utopia</em>, 1974): Rawls überbetont Risikoaversion. Eine waghalsige Person würde anders wählen. Und: Eigentum entsteht durch legitimen Erwerb – Umverteilung ist Zwangsarbeit.</p><p>Der Schleier ist verwandt mit Adam Smiths <em>impartial spectator</em>, mit Kants <em>kategorischem Imperativ</em> – aber präziser, weil er Eigeninteresse in den Dienst der Fairness stellt.</p>",
        "erkenntnis": "Wir bewerten Regeln meist aus unserer aktuellen Position. Der Schleier zwingt uns, Fairness von der Position dessen zu denken, der die Regeln am stärksten trifft. Das ist praktisch: In jeder Verhandlung, jedem Vertragsentwurf hilft die Frage 'Würde ich dieser Regel zustimmen, wenn ich nicht wüsste, auf welcher Seite ich stehe?'",
    },
    "erfahrungsmaschine": {
        "id": "erfahrungsmaschine", "name": "Die Erfahrungsmaschine", "icon": "🎮",
        "farbe": "indigo", "kategorie": "Philosophie",
        "schwierigkeit": "Einsteiger", "dauer": "4 min",
        "setup": "Neurowissenschaftler haben eine <strong>Erfahrungsmaschine</strong> entwickelt. Sie kann jede beliebige Erfahrung perfekt simulieren – ununterscheidbar von der Realität. Du kannst dir alles wünschen: bedeutsame Freundschaften, große Liebe, herausragende Leistungen, tiefe Glücksmomente.<br><br>Du wirst <strong>nicht wissen</strong>, dass du in der Maschine bist. Die Programmierung ist perfekt: kein Zweifel, kein Glitch. Du erlebst ein erfülltes Leben.<br><br>Die einzige Bedingung: <strong>Du schwebst in einem Tank</strong>, mit Elektroden am Kopf – während andere Menschen, echte Beziehungen und die wirkliche Welt ohne dich weitergehen.",
        "frage": "Würdest du dich anschließen?",
        "optionen": [
            {"text": "Ja – wenn das Erleben gleich ist, zählt nichts anderes", "hinweis": "Hedonistische Position"},
            {"text": "Nein – ich möchte wirklich etwas tun, nicht nur das Gefühl davon haben", "hinweis": "Nozicks erwartete Antwort"},
            {"text": "Nur für eine begrenzte Zeit – als Urlaub", "hinweis": "Mittelweg"},
            {"text": "Nur, wenn alle Menschen es täten", "hinweis": "Kollektivistische Variante"},
        ],
        "loesung_text": "Die meisten Menschen lehnen ab – und das widerlegt nach Nozick den reinen Hedonismus.",
        "erklaerung": "<p><strong>Robert Nozick</strong> formulierte das Experiment 1974 (<em>Anarchy, State, and Utopia</em>) als Argument gegen den <strong>Hedonismus</strong>: die These, das einzig intrinsisch Wertvolle sei angenehmes Erleben.</p><p>Nozicks Logik: Wenn nur Erleben zählt, sollte die Maschine offensichtlich vorzuziehen sein – sie liefert nachweislich mehr Glück. Die starke Intuition, sie abzulehnen, zeigt: <em>Wir wollen mehr als nur subjektives Glück.</em></p><p>Was wollen wir konkret?</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>Wirklich Dinge tun</strong>, nicht nur das Gefühl haben, sie zu tun</li><li><strong>Eine bestimmte Art Mensch sein</strong> – nicht nur ein 'unbestimmter Tankkörper'</li><li><strong>Kontakt zur Wirklichkeit</strong> – Wahrheit hat Eigenwert</li></ul>",
        "kontext": "<p>Das Gedankenexperiment ist heute aktueller denn je:</p><ul class=\"list-disc ml-4 mt-2 space-y-1 text-sm\"><li><strong>VR & Metaverse</strong>: Erste echte Vorboten der Erfahrungsmaschine. Wie viel virtuelles Erleben ist gesund?</li><li><strong>KI-Begleiter</strong>: Wenn ein KI-Partner besser auf dich eingeht als jeder Mensch – ist das eine echte Beziehung?</li><li><strong>Soziale Medien</strong>: Likes als 'Mini-Maschine' – kurzes Erleben sozialen Werts ohne reale Bindung.</li><li><strong>Antidepressiva</strong>: Eine Pille, die das Erleben verbessert – ist das schlechter als äußere Veränderungen, die dasselbe Erleben produzieren?</li></ul><p><strong>Variationen verschärfen die Frage:</strong><br>• Würdest du dein Kind anschließen?<br>• Was, wenn die reale Welt extrem trostlos ist?<br>• Sind Tagträume eine 'Mini-Erfahrungsmaschine'?</p><p><strong>Verwandte Theorien</strong>: Aristoteles' <em>eudaimonia</em> (Glück als Verwirklichung, nicht als Gefühl), Buddhistische Lehre von <em>Maya</em> (Illusion), Platons Höhlengleichnis.</p>",
        "erkenntnis": "Wir bewerten Leben nicht allein nach dem inneren Erleben. Authentizität, Verbindung zur Wirklichkeit und das Gefühl, dass unser Tun echte Wirkung hat, sind eigenständige Werte. Beim Entwerfen guter Produkte, Beziehungen oder Arbeitsplätze gilt es, mehr als nur 'Glücksgefühle' zu maximieren.",
    },
}
